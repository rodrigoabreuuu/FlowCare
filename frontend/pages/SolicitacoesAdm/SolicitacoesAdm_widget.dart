...
class SolicitacoesADMWidget extends StatefulWidget {
  ...
  static String routeName = 'SolicitacoesADM';
  static String routePath = '/solicitacoesADM';
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: FutureBuilder<List<SolicitacaoRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<SolicitacaoRow> dadosSolicitacaoRowList =
                              snapshot.data!;
                          ...
                          return ListView.separated(
                            ...
                            itemCount: dadosSolicitacaoRowList.length,
                            separatorBuilder: (_, __) => SizedBox(height: 15),
                            itemBuilder: (context, dadosIndex) {
                              final dadosSolicitacaoRow =
                                  dadosSolicitacaoRowList[dadosIndex];
                              return Container(
                                width: double.infinity,
                                height: 50,
                                decoration: BoxDecoration(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            16, 0, 16, 0),
                                        child: Text(
                                          dadosSolicitacaoRow.idSolicitacao
                                              .toString(),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            AprovarSolicitacaoWidget.routeName,
                                            queryParameters: {
                                              'aprovarSolicitacao':
                                                  serializeParam(
                                                dadosSolicitacaoRow,
