...
import 'cadastrar_crianca_model.dart';
export 'cadastrar_crianca_model.dart';

class CadastrarCriancaWidget extends StatefulWidget {
  const CadastrarCriancaWidget({super.key});

  static String routeName = 'CadastrarCrianca';
  static String routePath = '/cadastrarCrianca';

  @override
  State<CadastrarCriancaWidget> createState() => _CadastrarCriancaWidgetState();
}

class _CadastrarCriancaWidgetState extends State<CadastrarCriancaWidget> {
  late CadastrarCriancaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastrarCriancaModel());
    ...
    _model.dataNascTextController ??= TextEditingController();
    _model.dataNascFocusNode ??= FocusNode();

    _model.tDeficienciaTextController ??= TextEditingController();
